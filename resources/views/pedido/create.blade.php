...
<div style="margin-top: 40px">
    {{-- <div  class="card-header" style="background-color:#0dcaf0" >
      <h1 align="center" style="font-size: 40px; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color:white">Pedido</h1>
    </div> --}}
    <div class="content">
        <form id="formPedido" class="form was-validated" action=" {{ route('pedido.store') }} " method="POST">
            @csrf
                            ...
                            <div class="col-12 py-3 px-2 h-100 "
                                    ...
                                    <div class="card-body h-100 d-flex flex-column producto elevation-4"
                                        ...
                                        <div class="row" style="font-size: 12px">
                                            <div class="col-12" style="display:flex; justify-content:center;">
                                                ...
                                                @else
                                                <div class="bg-danger w-100 h-100 text-center">
                                                    Agotado
                                                </div>
                                                @endif
                                ...
                                <div class="card w-auto h-100 m-0">
                                    <div class="card-body h-100 d-flex flex-column producto elevation-4"
                                        ...
                                        <p style="font: 10px" align="center"><b>{{ $producto->nombre }}</b></p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 form-group">
                                    ...
                                    <input
                                        ...
                                        is-invalid
                                        @enderror
                                        value="BOLETA DE VENTA" name="ticket_type" id="ticket_type" class="form-control" type="text" required />
                                ...
                                <div class="col-6 form-group">
                                    ...
                                    <input
                                        ...
                                        is-invalid
                                        @enderror
                                        name="ticket_serie" id="ticket_serie" placeholder="A, B, C" class="form-control" type="text" required />
                                ...
                                <div class="col-6 form-group">
                                    ...
                                    <input
                                        ...
                                        is-invalid
                                        @enderror
                                        name="ticket_number" id="ticket_number" class="form-control" placeholder="000000000" type="text" required />
                                ...
                                <div class="col-6 form-group">
                                    ...
                                    <input
                                        ...
                                        is-invalid
                                        @enderror
                                        name="nombreCliente" id="nombreCliente" class="form-control" type="text" required />
                                ...
                                <div class="col-6 form-group">
                                    ...
                                    <input
                                        ...
                                        is-invalid
                                        @enderror
                                        name="apellidosCliente" id="apellidosCliente" class="form-control" type="text" required />
                                ...
                                <div class="col-8 form-group">
                                    ...
                                    <input
                                        ...
                                        is-invalid
                                        @enderror
                                        name="correo" id="correo" class="form-control" placeholder="example@hotmail.com" type="email">
                                ...
                                <div class="col-4 form-group">
                                    ...
                                    <input name="celular" id="celular" pattern="[0-9]{9}" class="form-control" type="text" required>
                                </div>
                                <div class="col-12 form-group">
                                    ...
                                    <input
                                        ...
                                        is-invalid
                                        @enderror
                                        name="direccion" id="direccion" class="form-control" type="text" required>
                                ...
                                <div class="col-12 form-group">
                                    <label for="">IGV (%)</label>
                                    <input name="tax" id="tax" class="form-control" type="number" min="1" value="18" required>
                                </div>
                                <div class="col-12 form-group">
                                    <label for="">Notas:</label>
                                    <textarea class="form-control" name="notas" id="notas" cols="3" rows="3" placeholder="Escriba su anotación para este pedido"></textarea>
                                </div>
                                <div class="col-12 form-group">
                                    <div class="row">
                                        <div class="col-6 pl-3">
                                            <label class="" for="chkDelivery">Delivery: &nbsp;</label>
                                            <input type="checkbox" class="" name="delivery" id="delivery">
                                        </div>

                                        <div class="col-6">
                                            <label for="">Total [S/.]:</label>
                                            <input style="border:none; background:none; text-align: right; font-size:20px" type="number"
                                                readonly name="total" id="total"></input>
                                        </div>
