...
<div class="card" style="margin-top: 40px">
    <div class="card-header" style="background-color:#0dcaf0">
        <h1 align="center" style="font-size: 40px; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color:white">Administrar Roles</h1>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="container">
                ...
                <div class="row d-flex align-items-stretch">
                    ...
                    <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch flex-column" style="margin-bottom: 40px">
                        <div class="card  d-flex flex-fill" style="background-color: #F0F1F2">
                            <h1 class="badge badge-info">Rol</h1>

                            <div class="card-body pt-0" style="background-color: #F0F1F2">
                                <div class="row">
                                    <div class="col-7">
                                        <h2 class="lead"><b>{{ $role->name}}</b></h2>
                                        <ul class="ml-4 mb-0 fa-ul text-muted">
                                            <li class="small"><span class="fa-li"><i class="fas fa-lg fa-eye"></i></span> Código: {{ $role->id}}</li>

                                            <li class="small"><span class="fa-li"><i class="fas fa-lg fa-question"></i></span>
                                                Nombre del rol:
                            ...
                            <div class="card-footer" style="background-color: #F0F1F2">
                                <div class="text-right btn-group" style="align-content:center">
                                    ...
                                    @can('roles.destroy')
                                    <form action="{{route('roles.destroy', $role)}}" method="POST" class="formulario-rol" class="formulario-eliminar float-left" style="margin-left: 3px">
                                        @csrf
                                        @method('DELETE')
...
@if (session::has('eliminar')== '¡Rol eliminado correctamente!')
<script>
    Swal.fire(
        '¡Eliminado!',
